...
const ABOUT_TEXT =
  'Somos a Orbi Company. Unimos tecnologia, estratégia e inteligência artificial para acelerar o crescimento de empresas — de sites de alto impacto a sistemas completos, automações, CRM e chatbots. Transformamos ideias em soluções digitais que geram resultados reais.';
